...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('admin.setting.show') }}" >Settings</a></li>
        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Setting Upadte</h3>
                    <div class="box-tools pull-right">
                        <a href="{{ route('admin.setting.show') }}" class="btn btn-box-tool"><span class="glyphicon glyphicon-arrow-left"></span>Back</a>
                    </div>
                </div>
                <div class="box-body">
                    <div class="col-lg-12">
                        <form name="user-update-form" id="settingEditFrm" action="{{ route('admin.setting.update') }}" class="form-horizontal form-label-left" method="POST" data-parsley-validate enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="form-group {{ $errors->has('app_version') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="app_version" id="app_version" class="form-control" placeholder="App Version" value="{{ old('app_version', $settings->app_version) }}"required="required">
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('site_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="site_name" id="site_name" class="form-control" placeholder="Enter Site Name" value="{{ old('site_name', $settings->site_name) }}"required="required">
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('site_description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="site_description" id="site_description" class="form-control" placeholder="Enter Site Description" value="{{ old('site_description', $settings->site_short_desc) }}"required="required">
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('contact_email') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="contact_email" id="contact_email" class="form-control" placeholder="Enter Contact Email" value="{{ old('contact_email', $settings->contact_email) }}"required="required" data-parsley-required>
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('new_join_one_month_free') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                     ...
                                     <select class="form-control" name="new_join_one_month_free" id="new_join_one_month_free">
                                       <option></option>
                            ...
                            <div class="form-group {{ $errors->has('mobile_no') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="tel" name="mobile_no" id="mobile_no" class="form-control" placeholder="Enter Mobile No." value="{{ old('mobile_no', $settings->mobile_no) }}"required="required">
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('alt_mobaile_no') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="tel" name="alt_mobaile_no" id="alt_mobaile_no" class="form-control" placeholder="Enter Alternative Mobile No." value="{{ old('alt_mobaile_no', $settings->alt_mobaile_no) }}">
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('addres_one') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="address_one" id="address_one" class="form-control" placeholder="Enter Address One" value="{{ old('addres_one', $settings->addres_one) }}"required="required">
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('address_two') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="address_two" id="address_two" class="form-control" placeholder="Enter Address Two" value="{{ old('address_two', $settings->address_two) }}">
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('currency') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="currency" id="currency" class="form-control" placeholder="Enter Currency" value="{{ old('currency', $settings->currency) }}"required="required" data-parsley-required>
                                </div>
                             ...
                             <div class="form-group {{ $errors->has('payment_gateway') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="payment_gateway" id="payment_gateway" class="form-control" placeholder="Enter Payment Gateway" value="{{ old('payment_gateway', $settings->payment_gateway) }}">
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('secret_key') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="secret_key" id="secret_key" class="form-control" placeholder="Enter Secret Key" value="{{ old('secret_key', $settings->secret_key) }}">
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('published_key') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="published_key" id="published_key" class="form-control" placeholder="Enter Published Key" value="{{ old('published_key', $settings->published_key) }}">
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('facebook_link') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="facebook_link" id="facebook_link" class="form-control" placeholder="Enter Facebook Link" value="{{ old('facebook_link', $settings->facebook_link) }}">
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('twitter_link') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="twitter_link" id="twitter_link" class="form-control" placeholder="Enter Twitter Link" value="{{ old('twitter_link', $settings->twitter_link) }}">
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('instagram_link') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="instagram_link" id="instagram_link" class="form-control" placeholder="Enter Instagram Link" value="{{ old('instagram_link', $settings->instagram_link) }}">
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('linkedin_link') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="linkedin_link" id="linkedin_link" class="form-control" placeholder="Enter LinkedIn Link" value="{{ old('linkedin_link', $settings->linkedin_link) }}">
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('copyright_content') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="copyright_content" id="copyright_content" class="form-control" placeholder="Enter Footer Copyright Content" value="{{ old('copyright_content', $settings->copyright_content) }}">
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('about_us') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea name="about_us" id="about_us" class="form-control textarea" data-parsley-required>{{ $settings->about_us }}</textarea>
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('help') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea name="help" id="help" class="form-control textarea">{{ $settings->help }}</textarea>
                                </div>
                                @if ($errors->has('help'))
                                    <span class="help-block">
                            ...
                            <div class="form-group {{ $errors->has('privacy_policy') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea name="privacy_policy" id="privacy_policy" class="form-control textarea" data-parsley-required>{{ $settings->privacy_policy }}</textarea>
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('term_of_use') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea name="term_of_use" id="term_of_use" class="form-control textarea">{{ $settings->term_of_use }}</textarea>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    ...
                                    <a href="{{ route('admin.setting.show') }}" class="btn btn-primary">Cancel</a>
                                </div>
                            </div>
