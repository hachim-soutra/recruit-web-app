<script>
    $(document).ready(function() {
        $(function () {
            $('#established_in').inputmask('yyyy-mm-dd', { 'placeholder': 'yyyy-mm-dd', yearrange: { minyear: 1600, maxyear: 2099, }})
        });

        $("#employer-add-frm").on("submit", function(e) {
            e.preventDefault(e);
            $.ajax({
                type: "POST",
                ...
                success: function(response) {
                    ...
                    if (response.data.status === "validation_error") {
                       ...
                       // window.location = "{{ route('admin.employer.list') }}";
                       window.history.back();
                    }
                },
        ...
        $("#employer-update-frm").on("submit", function(e) {
            e.preventDefault(e);
            $.ajax({
                type: "POST",
                url: $(this).attr("action"),
