                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" value="{{ @$detail->expire_date }}" class="form-control" id="expiredate" name="expiredate" >
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select name="status" id="status"
                                    ...
                                    @foreach (\App\Enum\NewsStatusEnum::cases() as $status)
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    @if($errors->has('detailnews'))
                                    <div class="erroralert">{{ $errors->first('detailnews') }}</div>
                                    @endif
                                </div>
                            </div>
                        </div>
