        ...
        <div class="box">
            <div class="row">
                <div class="box-body">
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="btn-group">
                            <a href="{{ route('admin.employer.list', 'active') }}" class="btn bg-purple btn-flat btn-sm">
                                Active Employers
                            </a>
                            <a href="{{ route('admin.employer.list', 'archived') }}" class="btn bg-navy btn-flat btn-sm">
                                Archive Employers
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            <tr>
                                ...
                                <th>Email</th>
                                <th>Mobile</th>
                                <th class="text-center">Active Subscription</th>
                            ...
                            @forelse ($data as $e)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if ($e->valid_subscription)
                                            <span class="subscribed m-auto">Yes</span>
                                        @else
                                            <p class="unsubscribed m-auto">No</p>
                                        @endif
                                    </td>
                                    <td class="text-center" id="userStatus-{{ $e->id }}">
                                        @if ($e->status == 1)
                                            <a href="{{ route('admin.employer.archive', $e->id) }}"
                                        ...
                                        @else
                                            <a href="{{ route('admin.employer.restore', $e->id) }}"
                                    ...
                                    <td class="text-center" id="userStatus-{{ $e->id }}">
                                        @if ($e->email_verified == 1)
                                            <a href="{{ route('admin.employer.email_archive', $e->id) }}"
                                        ...
                                        @else
                                            <a href="{{ route('admin.employer.email_restore', $e->id) }}"
                                    ...
                                    <td class="text-center" id="userStatus-{{ $e->id }}">
                                        @if (!empty($e->mobile))
                                            @if ($e->mobile_verified == 1)
                                                <a href="{{ route('admin.employer.mobile_archive', $e->id) }}"
                                            ...
                                            @else
                                                <a href="{{ route('admin.employer.mobile_restore', $e->id) }}"
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{ route('admin.employer.show', $e->id) }}"
                                                class="btn btn-xs btn-info">View</a>
                                            @if ($e->id != 1)
                                                <a href="{{ route('admin.employer.edit', $e->id) }}"
                                                    class="btn btn-xs btn-warning">Edit</a>
                                            @endif
                                            <a href="{{ route('admin.employer.jobs', $e->id) }}"
                                                class="btn btn-xs btn-primary">Jobs</a>
                                        </div>
                                    </td>
                                </tr>
                            @empty
