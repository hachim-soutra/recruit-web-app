        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Qualification Add From</h3>
                 ...
                 <div class="box-body">
                    <form name="qualificationCreateFrm" id="qualificationCreateFrm" action="{{ route('admin.qualification.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="name">Name</label>
                                    <input type="text" autocomplete="off" class="form-control" id="name" name="name" placeholder="Qualification Name">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
