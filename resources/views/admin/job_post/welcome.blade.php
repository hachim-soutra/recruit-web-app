...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Welcome Job Post</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">All Welcome Job Post List</h3>
                </div>
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover">
                        <tr>
                            ...
                            <th scope="col" style="width:19%;" class="text-center">Actions</th>
                        </tr>
                        @forelse ($data as $e)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <span class="activejob">Job Active</sapn>
                                    @else
                               ...
                               <td class="text-center">
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        @if(!$e->show_in_home)
                                            <a id="showInHomeFrm" href="{{ route('admin.job.show-home-job-update', $e->id) }}" class="btn btn-sm btn-success" data-id="{{ $e->id }}" data-method="POST" data-toggle="tooltip" data-placement="bottom" title="Show">
                                                Show in home
                                            </a>
                                        @else
                                            <a id="showInHomeFrm" href="{{ route('admin.job.show-home-job-update', $e->id) }}" class="btn btn-sm btn-danger" data-id="{{ $e->id }}" data-method="POST" data-toggle="tooltip" data-placement="bottom" title="Delete">
                                                Delete from home
                                            </a>
                                        @endif
                                    </div>
