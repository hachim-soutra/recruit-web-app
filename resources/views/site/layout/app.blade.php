...
<head>
    ...
    <script>
		...
		gtag('config', 'G-XEHLC0ELEJ',		{ 'allow_display_features': false });	/* AND */
		
		gtag('config', 'G-B2QBWK62L3',	{ 'allow_display_features': false });		/* WHO?! */
        gtag('config', 'UA-211972912-1',	{ 'allow_display_features': false });	/* WHO?! */
