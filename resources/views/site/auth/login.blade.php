                ...
                <div class="item-sec">
                    <nav>
                        <div class="nav nav-tabs nav-fill btn-bd" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="job-seeker-tab" data-toggle="tab" href="#job-seeker"
                                role="tab" aria-controls="job-seeker" aria-selected="true">Job Seeker</a>
                            <a class="nav-item nav-link" id="employer-tab" data-toggle="tab" href="#employer-profile"
                                role="tab" aria-controls="employer-profile" aria-selected="false">Employer</a>
                            <a class="nav-item nav-link" id="career-coach-tab" data-toggle="tab" href="#career-coach"
                                role="tab" aria-controls="career-coach" aria-selected="false">Career Coach</a>
                        </div>
                    </nav>
                    <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="job-seeker" role="tabpanel"
                            ...
                            <div class="form-bd">
                                @include('site.pages.partial.auth.login-form', ['usertype' => 'candidate'])
                            </div>
                        </div>
                        <!-- item-form-bd -->
                        <!-- item-form-bd -->
                        <div class="tab-pane fade" id="employer-profile" role="tabpanel" aria-labelledby="employer-tab">
                            <div class="form-bd">
                                @include('site.pages.partial.auth.login-form', ['usertype' => 'employer'])
                            </div>
                        </div>
                        <!-- item-form-bd -->
                        <!-- item-form-bd -->
                        <div class="tab-pane fade" id="career-coach" role="tabpanel" aria-labelledby="career-coach-tab">
                            <div class="form-bd">
                                @include('site.pages.partial.auth.login-form', ['usertype' => 'coach'])
                            </div>
                        </div>
                        <!-- item-form-bd -->
                    </div>
...
?>
    ...
    <form action="{{ route('common.job-listing') }}" method="post" id="jobsearchfromdashboard" style="display:none;">
        @csrf
        <input type="hidden" name="job_title" value="{{ @$search_job['job_title'] }}">
